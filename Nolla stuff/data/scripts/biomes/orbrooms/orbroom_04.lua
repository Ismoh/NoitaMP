...
function spawn_orb(x, y)
	...
	EntityLoad( "data/entities/items/books/book_04.xml", x - 30, y + 40 )
	...
	spawn_material_checker( x + 198, y - 11, "snow", "data/scripts/biomes/orbrooms/orbroom_shared.lua", "data/particles/image_emitters/orbrooms/07_02.xml", x, y - 100 )
