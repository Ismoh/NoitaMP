...
function init( x, y, w, h )
	...
	LoadPixelScene( "data/biome_impl/pyramid/entrance.png", "data/biome_impl/pyramid/entrance_visual.png", x, y, "data/biome_impl/pyramid/entrance_background.png", true )
end