...
gun.actions_per_round = 26
gun.reload_time = {24,38}
gun.shuffle_deck_when_empty = 0
gun.fire_rate_wait = {5,10}
gun.spread_degrees = {3,8}
gun.speed_multiplier = 1.5
...
ComponentObjectSetValue( ability_comp, "gunaction_config", "spread_degrees", get_random_between_range( gun.spread_degrees ) )
