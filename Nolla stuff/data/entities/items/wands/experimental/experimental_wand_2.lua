...
local gun = { }
gun.name = {"Colour wand"}
gun.deck_capacity = 10
gun.actions_per_round = 1
gun.reload_time = {40,60}
...
local colours = { "COLOUR_RED", "COLOUR_PURPLE", "COLOUR_ORANGE", "COLOUR_BLUE", "COLOUR_YELLOW", "COLOUR_GREEN" }

AddGunAction( entity_id, get_random_from( colours ) )
AddGunAction( entity_id, "SPITTER_TIER_3" )
AddGunAction( entity_id, get_random_from( colours ) )
AddGunAction( entity_id, "SPITTER_TIER_3" )
AddGunAction( entity_id, get_random_from( colours ) )
AddGunAction( entity_id, "SPITTER_TIER_3" )
AddGunAction( entity_id, "COLOUR_INVIS" )
AddGunAction( entity_id, "SPITTER_TIER_3" )
AddGunAction( entity_id, "COLOUR_RAINBOW" )
AddGunAction( entity_id, "SPITTER_TIER_3" )

local item_comp = EntityGetFirstComponent( entity_id, "ItemComponent" )
ComponentSetValue2( item_comp, "item_name", "$item_wand_experimental_2" )
